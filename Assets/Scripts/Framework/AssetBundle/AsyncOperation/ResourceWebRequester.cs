...
namespace AssetBundles
{
    ...
    public class ResourceWebRequester : ResourceAsyncOperation
    {
        ...
        protected bool checkIndependent = false;

        private float loadBeginTime = 0f;
        ...
        public override void Update()
        {
            ...
            {
                Logger.LogError(www.error + " " + www.url);
            }
#if UNITY_EDITOR
            KVDebugHelper.Instance.AddLoadTimeInfo(www.url, Time.time - loadBeginTime, www.bytes.Length);
#endif
        }
