...
namespace AssetBundles
{
    ...
    {
        //%:ctrl,#:shift,&:alt
        const string kSimulateMode = "AssetBundles/Switch Model/模拟器模式";
        const string kSimulateMode_UseLuaScripts = "AssetBundles/Switch Model/模拟器模式并使用Lua脚本";
        const string kEditorMode = "AssetBundles/Switch Model/编辑器模式";
        ...
        const string kCreateSceneAssetBundle = "Assets/AssetBundles/Create Scene AssetBundle For CurScene";
        ...
        [MenuItem(kSimulateMode_UseLuaScripts)]
        ...
        [MenuItem(kSimulateMode_UseLuaScripts, true)]
        public static bool ToggleSimulateMode_UseLuaScriptsValidate()
        {
            Menu.SetChecked(kSimulateMode_UseLuaScripts, AssetBundleConfig.IsSimulateMode_UseLuaScripts);
            return true;
        }
...
//            }
        ...
        [MenuItem(kCreateSceneAssetBundle)]
        static public void CreateSceneAssetBundle()
        {
            //清空缓存
            Caching.ClearCache();
            Object[] selObjs = Selection.objects;
            ...
            {
                //固定路径
                string path = Application.dataPath + "/AssetsPackage/Scenes/" + selObjs[i].name + ".unityScene";
