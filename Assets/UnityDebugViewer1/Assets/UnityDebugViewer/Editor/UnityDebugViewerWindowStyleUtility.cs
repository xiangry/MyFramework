    ...
    public static class UnityDebugViewerWindowStyleUtility 
    {
        ...
        public static Texture2D errorIconSmallTexture
        {
            get
            {
                ...
                {
                    _errorIconSmallTexture = EditorGUIUtilityEx.LoadIcon("icons/console.erroricon.sml");
//                    _errorIconSmallTexture = EditorGUIUtility.Load("console.erroricon.sml.png") as Texture2D;
                }
