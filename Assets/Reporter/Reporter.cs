...
public class Reporter : MonoBehaviour {
	...
	public void Initialize()
	{
		if( !created )
		{
			...
			scenes = new List<string>(SceneManager.sceneCountInBuildSettings);
	...
	void Update()
	{
		...
		//addSample();
		if (scenes.Count < SceneManager.GetActiveScene().buildIndex)
		{
			scenes.Append(SceneManager.GetActiveScene().name);
		}
...
//			scenes[SceneManager.GetActiveScene().buildIndex] = SceneManager.GetActiveScene().name;
	...
	void OnSceneLoaded(Scene scene , LoadSceneMode mode)
	{
		...
		Debug.Log("LoadSceneMode :" + Enum.GetName(typeof(LoadSceneMode) , mode));
	}
